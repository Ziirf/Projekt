...
namespace Projekt
{
    class SQL
    {
        ...
        public static void CreateCar(int customerID, string vinNumber, string numberPlate, string carBrand, string carModel, int productionYear, int kmCount, string fuelType)
        {
            ...
            query = "SELECT TOP 1 car.customerID, car.vinNumber, car.numberPlate, car.carBrand, car.carModel, car.productionYear, car.kmCount, car.fuelType, car.createdDate ORDER BY customerID DESC;";
            SqlDataAdapter sda = new SqlDataAdapter(query, con);
